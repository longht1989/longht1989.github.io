...
(function ($) {
    ...
    sgallery = {
        ...
        prepareHTML: function (imgs) {
            ...
            O.SG.left = $('<a class="Sarrow l"><img src="App_Themes/img/arr-left.jpg" height="73" width="49" ></a>');
            O.SG.right = $('<a class="Sarrow r"><img src="App_Themes/img/arr-right.jpg" height="73" width="49" ></a>');
